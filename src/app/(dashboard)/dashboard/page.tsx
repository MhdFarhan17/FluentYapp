...
const CURRICULUM = [
  {
    ...
    lessons: [
      { id: "intro-1", title: "Introduction", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "translate-x-0", requires: "" },
      { id: "basics-1", title: "Basics 1", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "intro-1" },
      { id: "basics-2", title: "Basics 2", color: "bg-pink-500", shadow: "shadow-[0_8px_0_0_#be185d]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "basics-1" },
      { id: "phrases-1", title: "Phrases", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "translate-x-0", requires: "basics-2" },
      { id: "numbers-1", title: "Numbers", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "phrases-1" },
    ]
  },
  {
    unit: 2,
    title: "Unit 2: Everyday Objects",
    description: "Learn about food, animals, and what you wear.",
    bgColor: "bg-purple-600",
    iconColor: "text-purple-300",
    lessons: [
      { id: "articles-1", title: "Articles", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "numbers-1" },
      { id: "food-1", title: "Food", color: "bg-pink-500", shadow: "shadow-[0_8px_0_0_#be185d]", position: "translate-x-0", requires: "articles-1" },
      { id: "animals-1", title: "Animals", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "food-1" },
      { id: "clothing-1", title: "Clothing", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "animals-1" },
      { id: "colors-1", title: "Colors", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "translate-x-0", requires: "clothing-1" },
    ]
  },
  {
    unit: 3,
    title: "Unit 3: Expressing Yourself",
    description: "Plurals, adjectives, body parts, and family.",
    bgColor: "bg-pink-600",
    iconColor: "text-pink-300",
    lessons: [
      { id: "plurals-1", title: "Plurals", color: "bg-pink-500", shadow: "shadow-[0_8px_0_0_#be185d]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "colors-1" },
      { id: "adjectives-1", title: "Adjectives", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "plurals-1" },
      { id: "present-tense-1", title: "Present Tense", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "translate-x-0", requires: "adjectives-1" },
      { id: "body-1", title: "Body Parts", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "present-tense-1" },
      { id: "family-1", title: "Family", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "body-1" },
    ]
  },
  {
    unit: 4,
    title: "Unit 4: Navigating the World",
    description: "Questions, prepositions, time, and weather.",
    bgColor: "bg-orange-500",
    iconColor: "text-orange-200",
    lessons: [
      { id: "questions-1", title: "Questions", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "translate-x-0", requires: "family-1" },
      ...
      { id: "directions-1", title: "Directions", color: "bg-pink-500", shadow: "shadow-[0_8px_0_0_#be185d]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "prepositions-1" },
      { id: "time-1", title: "Time", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "translate-x-0", requires: "directions-1" },
      { id: "weather-1", title: "Weather", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "time-1" },
    ]
  },
  {
    unit: 5,
    title: "Unit 5: Real-World Survival",
    description: "House, jobs, travel, dining, and shopping.",
    bgColor: "bg-amber-500",
    iconColor: "text-amber-200",
    lessons: [
      { id: "house-1", title: "House", color: "bg-amber-500", shadow: "shadow-[0_8px_0_0_#b45309]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "weather-1" },
      { id: "jobs-1", title: "Jobs", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "translate-x-0", requires: "house-1" },
      { id: "travel-1", title: "Travel", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "jobs-1" },
      { id: "restaurant-1", title: "Restaurant", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "travel-1" },
      { id: "shopping-1", title: "Shopping", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "translate-x-0", requires: "restaurant-1" },
    ]
  },
  {
    unit: 6,
    title: "Unit 6: Activities & Health",
    description: "School, sports, hobbies, nature, and health.",
    bgColor: "bg-lime-600",
    iconColor: "text-lime-300",
    lessons: [
      { id: "school-1", title: "School", color: "bg-lime-500", shadow: "shadow-[0_8px_0_0_#4d7c0f]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "shopping-1" },
      { id: "sports-1", title: "Sports", color: "bg-pink-500", shadow: "shadow-[0_8px_0_0_#be185d]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "school-1" },
      { id: "hobbies-1", title: "Hobbies", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "translate-x-0", requires: "sports-1" },
      { id: "nature-1", title: "Nature", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "hobbies-1" },
      { id: "health-1", title: "Health", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "nature-1" },
    ]
  },
  {
    unit: 7,
    title: "Unit 7: Business & Professional",
    description: "Workplace communication and business terms.",
    bgColor: "bg-teal-600",
    iconColor: "text-teal-300",
    lessons: [
      { id: "business-1", title: "Business", color: "bg-teal-500", shadow: "shadow-[0_8px_0_0_#0f766e]", position: "translate-x-0", requires: "health-1" },
      { id: "emails-1", title: "Emails", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "business-1" },
      ...
      { id: "tech-1", title: "Tech", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "translate-x-0", requires: "interview-1" },
      { id: "finance-1", title: "Finance", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "tech-1" },
    ]
  },
  {
    unit: 8,
    title: "Unit 8: Intermediate Grammar",
    description: "Continuous, comparatives, modals, past & future.",
    bgColor: "bg-indigo-600",
    iconColor: "text-indigo-300",
    lessons: [
      { id: "present-continuous-1", title: "Present Cont.", color: "bg-indigo-500", shadow: "shadow-[0_8px_0_0_#3730a3]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "finance-1" },
      { id: "comparatives-1", title: "Comparatives", color: "bg-pink-500", shadow: "shadow-[0_8px_0_0_#be185d]", position: "translate-x-0", requires: "present-continuous-1" },
      { id: "modals-1", title: "Modals", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "comparatives-1" },
      { id: "past-tense-1", title: "Past Tense", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "modals-1" },
      { id: "future-tense-1", title: "Future Tense", color: "bg-green-500", shadow: "shadow-[0_8px_0_0_#15803d]", position: "translate-x-0", requires: "past-tense-1" },
    ]
  },
  {
    unit: 9,
    title: "Unit 9: Mastery & Nuance",
    description: "Perfect tense, phrasal verbs, idioms, and slang.",
    bgColor: "bg-rose-600",
    iconColor: "text-rose-300",
    lessons: [
      { id: "present-perfect-1", title: "Present Perf.", color: "bg-rose-500", shadow: "shadow-[0_8px_0_0_#9f1239]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "future-tense-1" },
      { id: "phrasal-verbs-1", title: "Phrasal Verbs", color: "bg-blue-500", shadow: "shadow-[0_8px_0_0_#1d4ed8]", position: "-translate-x-6 sm:-translate-x-12 md:-translate-x-20", requires: "present-perfect-1" },
      { id: "idioms-1", title: "Idioms", color: "bg-orange-500", shadow: "shadow-[0_8px_0_0_#c2410c]", position: "translate-x-0", requires: "phrasal-verbs-1" },
      { id: "slang-1", title: "Slang", color: "bg-purple-500", shadow: "shadow-[0_8px_0_0_#7e22ce]", position: "translate-x-6 sm:translate-x-12 md:translate-x-20", requires: "idioms-1" },
  ...
  {
    unit: 10,
    title: "Unit 10: Local Context (Jakarta)",
    description: "Jabodetabek lifestyle, streetfood, and social.",
    bgColor: "bg-red-600",
